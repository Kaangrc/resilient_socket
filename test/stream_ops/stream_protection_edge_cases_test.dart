...
void main() {
  group(
    'StreamProtection edge cases — errors, completion, and flush semantics',
    () {
  ...
  group(
    'ResilientSocket edge cases — connect guards and disposed-state enforcement',
    () {
      test(
        'connect when already connecting/connected/reconnecting/disposed',
        () {
          fakeAsync((async) {
      ...
      test(
        'unsubscribe non-existent spec and send/sub/unsub when disposed',
        () {
          fakeAsync((async) {
            final socket =
                ResilientSocket(
